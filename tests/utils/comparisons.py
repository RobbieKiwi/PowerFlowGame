...
def game_states_are_equal(game_state1: GameState, game_state2: GameState) -> bool:
    ...
    if not (
        game_state1.game_id == game_state2.game_id and
        game_state1.game_settings == game_state2.game_settings and
        game_state1.phase == game_state2.phase and
        game_state1.players == game_state2.players and
        game_state1.buses == game_state2.buses and
        game_state1.assets == game_state2.assets and
        game_state1.transmission == game_state2.transmission
    ):
        return False
...
def assert_game_states_are_not_equal(game_state1: GameState, game_state2: GameState) -> None:
    assert not game_states_are_equal(game_state1=game_state1, game_state2=game_state2), \
